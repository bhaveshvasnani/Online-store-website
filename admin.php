...
<div class="banner-bg banner-bg1">	
	  <div class="container">
			 <div class="header">
			       ...
			       <div class="logo">
						 <a href="admin.php"><img src="images/logo.png" alt=""/><h2>BOOKRENTALS</h2></a>
				   </div>	
...
<h3>Sign In</h3>
  <form action="admin_login_res.php" method="POST">
  <table><tr><td>
    <label for="fname">Email</label></td>
    <td><input type="text" id="" name="username" placeholder="Your Email..">
	</td></tr>
	<br>
	<tr><td>
    <label for="lname">Password</label></td>
    <td><input type="password" id="" name="password" placeholder="Your password..">
	</td></tr>
